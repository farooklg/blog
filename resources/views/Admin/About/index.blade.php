        ...
        <div class="row mb-5">
          ...
          <div class="d-md-flex post-entry-2 half">
            <a href="#" class="me-4 thumbnail">
              <img src="{{ asset('zenblog/assets/img/post-landscape-2.jpg')}}" alt="" class="img-fluid">
            </a>
            <div class="ps-md-5 mt-4 mt-md-0">
              <div class="post-meta mt-4">About us</div>
              <h2 class="mb-4 display-4">Company History</h2>
              <p>{{ $about->company_history }}</p>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row justify-content-between align-items-lg-center">
          ...
          <div class="col-lg-6">
            <div class="row">
              <div class="col-6">
                <img src="{{ asset('zenblog/assets/img/post-portrait-3.jpg')}}" alt="" class="img-fluid mb-4">
              </div>
              <div class="col-6 mt-4">
                <img src="{{ asset('zenblog/assets/img/post-portrait-4.jpg')}}" alt="" class="img-fluid mb-4">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          ...
          <div class="col-lg-4 text-center mb-5">
            ...
            <img src="{{ asset('images/'.$team->image)}}" alt="" class="img-fluid rounded-circle w-50 mb-4">
