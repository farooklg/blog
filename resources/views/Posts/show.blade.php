                ...
                <div class="row">
                    <div class="col-md-9 post-content" data-aos="fade-up">
                        ...
                        <div class="single-post">
                            ...
                            <p><span class="firstcharacter">{{ substr($post->description, 5,1) }}</span>{{ substr($post->description, 6) }}</p>

                            <figure class="my-4">
                                <img src="{{ asset('zenblog/assets/img/post-landscape-1.jpg') }}" alt=""
                                    class="img-fluid">
                            ...
                            <p>Est soluta veritatis laboriosam, consequuntur temporibus asperiores, fugit id a ullam sed,
                                ...
                                corrupti porro.</p>
                            <figure class="my-4">
                                <img src="{{ asset('zenblog/assets/img/post-landscape-5.jpg') }}" alt=""
                                    class="img-fluid">
                                <figcaption>Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo, odit?
                                </figcaption>
                            </figure>
                            ...
                            <div class="comment d-flex mb-4">
                                <div class="flex-shrink-0">
                                    <div class="avatar avatar-sm rounded-circle">
                                        <img class="avatar-img" src="{{ asset('zenblog/assets/img/person-5.jpg') }}"
                                            alt="" class="img-fluid">
                                    </div>
                                </div>
                                ...
                                <div class="comment-replies bg-light p-3 mt-3 rounded">
                                    ...
                                    <div class="reply d-flex mb-4">
                                        <div class="flex-shrink-0">
                                            <div class="avatar avatar-sm rounded-circle">
                                                <img class="avatar-img" src="{{ asset('zenblog/assets/img/person-4.jpg') }}"
                                                    alt="" class="img-fluid">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-2 ms-sm-3">
                                        ...
                                        <div class="flex-shrink-0">
                                            <div class="avatar avatar-sm rounded-circle">
                                                <img class="avatar-img"
                                                    src="{{ asset('zenblog/assets/img/person-3.jpg') }}" alt=""
                                                    class="img-fluid">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-2 ms-sm-3">
                        ...
                        <div class="comment d-flex">
                            <div class="flex-shrink-0">
                                <div class="avatar avatar-sm rounded-circle">
                                    <img class="avatar-img" src="{{ asset('zenblog/assets/img/person-2.jpg') }}"
                                        alt="" class="img-fluid">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <form action="{{ route('comments.store') }}" method="POST">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <textarea class="form-control" id="content" name="content" placeholder="Enter your message" cols="30"
                                            rows="10"></textarea>
                                    </div>
                                    @if (auth()->check())
                                        <div class="col-12">
                                    ...
                                    @else
                                        <div class="col-12">
                                            <a href="{{ route('login') }}" class="btn btn-primary">Login to add comment</a>
                                        </div>
                                    @endif
                                    @if ($errors->any())
