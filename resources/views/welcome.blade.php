          ...
          <div class="col-lg-8">
            <div class="row g-5">
              <div class="col-lg-4 border-start custom-border">
                @foreach ($latestPosts as $categoryName => $latestpost )
                <div class="post-entry-1">
                    <a href="{{ route('posts.show',$latestpost->id)}}"><img src="{{ url('storage/images/'.$latestpost->image)}}" alt="" class="img-fluid"></a>
                    <div class="post-meta"><span class="date">{{ $latestpost->category->name }}</span> <span class="mx-1">&bullet;</span> <span>{{ $latestpost->created_at }}</span></div>
                    <h2><a href="{{ route('posts.show',$latestpost->id)}}">{{ $latestpost->title }}</a></h2>
                  </div>
                    @endforeach
              </div>
            </div>
